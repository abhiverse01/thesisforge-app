...
const ACADEMIC_STOPWORDS = new Set([
  ...
  // Additional academic stop words for completeness
  'discussion', 'conclusion', 'introduction', 'abstract', 'literature',
  'review', 'overview', 'summary', 'finding', 'findings', 'outcome',
  'implication', 'performance', 'experiment', 'evaluation', 'comparison',
  'implementation', 'application', 'technique', 'algorithm', 'architecture',
  'proposed', 'presented', 'previous', 'related', 'current', 'novel',
  'significant', 'important', 'relevant', 'similar', 'different',
  'general', 'specific', 'particular', 'various', 'overall',
]);
