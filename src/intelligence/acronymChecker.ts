...
const SKIP_WORDS = new Set([
  'I', 'A', 'II', 'III', 'IV', 'VI', 'VII', 'VIII', 'IX', 'X',
  // Common pre-defined academic acronyms that don't need definition
  'IT', 'AI', 'ML', 'NLP', 'API', 'URL', 'DOI', 'PDF', 'HTML', 'CSS',
  'SQL', 'XML', 'JSON', 'HTTP', 'TCP', 'GPU', 'CPU', 'RAM', 'RGB', 'GPS',
  'LHC', 'DNA', 'RNA', 'CT', 'MRI', 'WHO', 'UN', 'EU', 'UK', 'US',
]);
