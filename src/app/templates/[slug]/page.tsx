...
\\end{document}`,
  ...
  conference: {
    slug: "conference",
    seoTitle: "Free Conference Paper LaTeX Template",
    description:
    ...
    keyword: "conference paper latex template",
    chapters: [
      "Title Page",
      "Abstract",
      "Introduction",
...
The conference paper template is ideal for researchers submitting to IEEE, ACM, Springer, and other major conference venues. It supports IEEE citation style by default (numeric referencing), but you can switch to APA, Chicago, Harvard, or Vancouver with a single click. With support for figures, tables, equations, and automatic cross-referencing, ThesisForge gives you the full power of LaTeX conference paper formatting without any of the complexity.`,
    latexSnippet: `\\documentclass[10pt,conference]{IEEEtran}
\\usepackage[utf8]{inputenc}
\\usepackage[T1]{fontenc}
\\usepackage{graphicx}
\\usepackage{amsmath,amssymb}
...
\\end{document}`,
    faqs: [
      {
        question: "What is a conference paper LaTeX template?",
        answer:
      ...
      {
        question: "How many pages should a conference paper be?",
        answer:
      ...
      {
        question: "Which citation style should I use for a conference paper?",
        answer:
      ...
      {
        question: "Can I include figures and tables in my conference paper?",
        answer:
      ...
      {
        question: "Is this template compatible with IEEE and ACM conferences?",
        answer:
