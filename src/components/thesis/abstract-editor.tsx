        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <Textarea
              ...
              className="text-sm min-h-[150px] resize-none leading-relaxed max-h-[500px] overflow-y-auto"
            />
                ...
                {suggestedKeywords
                  ...
                  .map((sk) => (
                    <button
                      key={sk}
                      type="button"
                      className="text-xs px-2 py-0.5 rounded-full border border-dashed border-primary/30 text-primary/70 hover:bg-primary/10 hover:border-primary/50 transition-colors min-h-[44px]"
                      aria-label={`Add keyword: ${sk}`}
