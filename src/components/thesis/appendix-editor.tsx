...
export function AppendixEditor() {
  ...
  const addAppendix = useThesisStore(s => s.addAppendix);
  const removeAppendix = useThesisStore(s => s.removeAppendix);
  const updateAppendix = useThesisStore(s => s.updateAppendix);
        ...
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
              <button type="button" className="inline-flex items-center justify-center min-h-[44px] min-w-[44px] text-muted-foreground hover:text-foreground transition-colors" aria-label="More info about appendices">
            ...
            {appendices.length === 0 ? (
              ...
              >
                ...
                <Button
                  ...
                  onClick={addAppendix}
                  size="sm"
                  className="gap-2 text-xs min-h-[48px]"
                >
              ...
              <div className="space-y-3">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {isEditing ? (
                              <Input
                                ...
                                className="text-sm flex-1 h-9 sm:h-7"
                                ...
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <Button
                                      ...
                                      variant="ghost"
                                      size="sm"
                                      className="h-7 w-7 p-0 text-destructive hover:text-destructive shrink-0 min-h-[44px] min-w-[44px]"
                                      onClick={(e) => {
                                        e.stopPropagation();
                ...
                <div className="flex justify-center pt-1">
                  <Button
                    ...
                    size="sm"
                    onClick={addAppendix}
                    className="gap-2 text-xs border-dashed min-h-[48px]"
                  >
                    <Plus className="w-3.5 h-3.5" />
                    Add Appendix
                  </Button>
